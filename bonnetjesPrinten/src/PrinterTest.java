...
public class PrinterTest {
    ...
    public PrinterTest(String fName, String lName, String aTM, String amount) {
    ...
    public static class MyPrintable implements Printable {
        ...
        private Image getPictrue() {
            ...
            {
                picture = ImageIO.read(new File("image.jpg"));
            } catch (IOException e) {
                picture = null;
            }
            return picture;
...
*/
                //g2d.drawImage(getPictrue(), 0, 0, 60, 60, null);
                int tempfontsize = 2 * g2d.getFontMetrics().getHeight();
                g2d.setFont(new Font("TimesRoman", Font.PLAIN, 10));
                drawString(g2d, string, 0, fm.getAscent() + tempfontsize);
                result = PAGE_EXISTS;
            }
            return result;
