...
Als de gebruiker een pincode invoert dan zal eerst de salt worden toegegoegd, waarna het door een hashing methode gaat.
Daarna wordt het vergeleken met de database.
Ik raad aan om dit systeem te gebruiken voor de "Centrale server".
